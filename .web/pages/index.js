...
export default function Component() {
  ...
  <HStack spacing={`1em`}>
  <Avatar name={`Edward Trinidad`} size={`xl`} src={`avatar.png`} sx={{"color": "#C3C7CB", "bg": "#171F26", "padding": "2px", "border": "4px", "borderColor": "#14A1F0"}}/>
  ...
  <Link as={NextLink} href={`https://github.com/eatsangels`} isExternal={true} sx={{"textDecoration": "none", "_hover": {}}}>
  ...
  <Link as={NextLink} href={`https://www.instagram.com/etrinidad`} isExternal={true} sx={{"textDecoration": "none", "_hover": {}}}>
  ...
  <Link as={NextLink} href={`https://www.twitch.tv/eatsangels`} isExternal={true} sx={{"width": "100%", "textDecoration": "none", "_hover": {}}}>
  ...
  <Link as={NextLink} href={`https://discord.com/invite/wESxkYdCGy`} isExternal={true} sx={{"width": "100%", "textDecoration": "none", "_hover": {}}}>
  <Button sx={{"width": "100%", "height": "100%", "padding": "0.5em", "borderRadius": "1em", "color": "#F1F2F4", "backgroundColor": "#171F26", "whiteSpace": "normal", "textAlign": "start", "_hover": {"backgroundColor": "#087ec4"}}}>
  <HStack sx={{"width": "100%"}}>
  ...
  <Link as={NextLink} href={`https://github.com/eatsangels`} isExternal={true} sx={{"width": "100%", "textDecoration": "none", "_hover": {}}}>
  <Button sx={{"width": "100%", "height": "100%", "padding": "0.5em", "borderRadius": "1em", "color": "#F1F2F4", "backgroundColor": "#171F26", "whiteSpace": "normal", "textAlign": "start", "_hover": {"backgroundColor": "#087ec4"}}}>
  <HStack sx={{"width": "100%"}}>
  <ChakraImage alt={`EdwardTrinidad`} src={`icons/logo.png`} sx={{"width": "1.5em", "height": "1.5em", "margin": "0.8em"}}/>
  <VStack alignItems={`start`} spacing={`0.5em`} sx={{"paddingY": "0.5em", "paddingRight": "0.5em"}}>
  <Text sx={{"fontSize": "1em"}}>
  {`EdwardTrinidad`}
</Text>
  ...
  <Link as={NextLink} href={`mailto:alexandertrinidad@gmail.com`} isExternal={true} sx={{"width": "100%", "textDecoration": "none", "_hover": {}}}>
  <Button sx={{"width": "100%", "height": "100%", "padding": "0.5em", "borderRadius": "1em", "color": "#F1F2F4", "backgroundColor": "#171F26", "whiteSpace": "normal", "textAlign": "start", "_hover": {"backgroundColor": "#087ec4"}}}>
  <HStack sx={{"width": "100%"}}>
  ...
  <ChakraImage alt={`Logotipo de EdwardTrinidad. Una "eme" entre llaves.`} src={`logoedward.png`} sx={{"height": "4em", "width": "4em"}}/>
  <Link as={NextLink} href={`https://github.com/eatsangels`} isExternal={true} sx={{"fontSize": "0.8em", "textDecoration": "none", "_hover": {}}}>
  <Box>
  {`© 2014-2023 `}
  <Text as={`span`} sx={{"color": "#14A1F0"}}>
  {`EdwardTrinidad by Desarrollador.`}
</Text>
  {` v3.`}
</Box>
</Link>
  ...
  <NextHead>
  <title>
  {`Edward Trinidad | soy desarrollo de software`}
</title>
  <meta content={`Hola, mi nombre es Edward Trinidad. Soy ingeniero de software, desarrollador freelance full-stack.`} name={`description`}/>
